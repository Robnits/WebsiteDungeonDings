...
<body class="container">
        ...
        <header class="header">
            <h1>DungeonDings</h1>
            <img class="account-icon" src="icons/7.png" alt="account-icon">
        ...
        <nav class="nav">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="blogs.html"><img class="account-icon" src="icons/4.png" alt="Dev-Blog-icon"><p>Dev-Blog</p></a></li>
                <li><a href="Support.html"><img class="account-icon" src="icons/5.png" alt="Contact Us-icon"><p>Contact Us</p></a></li>
